...
![screenshot-1](https://github.com/zitrax1/devops-netology/blob/main/docker_prc/img/docker_prc_1.jpg)
...
6. В качестве ответа повторите  sql-запрос и приложите скриншот с данного сервера, bash-скрипт и ссылку на fork-репозиторий. - [скрипт](https://github.com/zitrax1/devops-netology/blob/main/docker_prc/project.sh), [fork_repo](https://github.com/zitrax1/shvirtd-example-python)

![screenshot-1](https://github.com/zitrax1/devops-netology/blob/main/docker_prc/img/docker_prc_2.jpg)
